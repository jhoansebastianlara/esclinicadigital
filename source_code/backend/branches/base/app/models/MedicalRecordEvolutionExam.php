...
class MedicalRecordEvolutionExam extends Eloquent {
	 ...
	 * @var string
	 */
	protected $table = 'medical_record_evolution_exam';
	...
	*/
	 ...
	 * @var string
	 */
	protected $primaryKey = 'medicalRecordEvolutionExamId';
